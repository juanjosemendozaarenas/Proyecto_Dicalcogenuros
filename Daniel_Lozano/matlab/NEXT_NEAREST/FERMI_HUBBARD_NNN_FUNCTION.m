...
a=0.0; %Parametro entre patas del
...
for i=(1:N-1)
    ...
    ID2=A_id{N-i};
    if(mod(i,2)==1)
        Ham=Ham-J*a*kron(ID1,kron(CdC+CCd,ID2))+V*a*kron(ID1,kron(N_T_2,ID2));
    end 
end
...
N_T_P_2=kron(N_T,kron(eye(4),N_T)); %interaccion densidad densidad
